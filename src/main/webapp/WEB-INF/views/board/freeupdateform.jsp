               ...
               <div class="row">
                  ...
                  <div class="col-md-10">
                     <div class="contact-form mb60">
                        <h3>수정페이지</h3>
                        <form action="archieveupdate.do" method="post" enctype="multipart/form-data">
                        <ul class="cform">
                           <li class="full">
                           	  <input type='hidden' name="archieve_no" value=${archieve.archieve_no}>
                           ...
                           <li class="full">
                              <input type="submit" value="확인" onclick="location.href=archieveupdate.do" class="fsubmit">
                           </li>
                        </ul>
                        </form>
                     </div>
